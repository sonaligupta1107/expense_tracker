...
export const incomeCategories = [
    ...
    { type: 'Lottery', amount: 0, color: incomeColors[6] },
    { type: 'Gifts', amount: 0, color: incomeColors[7] },
    { type: 'Rental income', amount: 0, color: incomeColors[8] },
];

export const expenseCategories = [
    { type: 'Bills', amount: 0, color: expenseColors[0] },
    { type: 'Grocery', amount: 0, color: expenseColors[1] },
    ...
    { type: 'Car', amount: 0, color: expenseColors[9] },
